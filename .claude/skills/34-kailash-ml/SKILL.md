---
name: 34-kailash-ml
description: "kailash-ml lifecycle framework — 13 engines (FeatureStore, ModelRegistry, TrainingPipeline, DriftMonitor, AutoML, etc.), polars-native, ONNX export, agent-augmented search. Use when asking about 'kailash-ml', 'ML lifecycle', 'feature store', 'model registry', 'training pipeline', 'drift monitor', 'AutoML', 'hyperparameter search', 'ensemble', 'ONNX', 'inference server', 'ML engines', or 'model versioning'."
---
