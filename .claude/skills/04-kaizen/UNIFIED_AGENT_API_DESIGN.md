...
**Files Referenced**:
- `./kailash_kaizen/apps/kailash-kaizen/src/kaizen/__init__.py`
- `./kailash_kaizen/apps/kailash-kaizen/src/kaizen/core/base_agent.py`
- `./kailash_kaizen/apps/kailash-kaizen/src/kaizen/agents/__init__.py`
- `./kailash_kaizen/apps/kailash-kaizen/src/kaizen/strategies/__init__.py`
- `./kailash_kaizen/apps/kailash-kaizen/src/kaizen/tools/__init__.py`
- `./kailash_kaizen/apps/kailash-kaizen/src/kaizen/memory/__init__.py`
- `./kailash_kaizen/.claude/skills/04-kaizen/README.md`
