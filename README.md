...
<p align="center">
  The core engine for building trust-verified workflows with 140+ production-ready nodes, sync and async runtimes, cyclic workflow support, and the CARE/EATP cryptographic trust framework. Three application frameworks -- <a href="https://github.com/Integrum-Global/kailash-kaizen">Kaizen</a> (AI agents), <a href="https://github.com/Integrum-Global/kailash-nexus">Nexus</a> (multi-channel platform), and <a href="https://github.com/Integrum-Global/kailash-dataflow">DataFlow</a> (database operations) -- are built on this foundation.
</p>
...
- **Foundation for three application frameworks** -- [Kaizen](https://github.com/Integrum-Global/kailash-kaizen) (AI agents with trust), [Nexus](https://github.com/Integrum-Global/kailash-nexus) (multi-channel deploy), and [DataFlow](https://github.com/Integrum-Global/kailash-dataflow) (zero-config database) are all built on this Core SDK.
...
`pip install kailash-kaizen` | [Repository](https://github.com/Integrum-Global/kailash-kaizen) | [Documentation](https://github.com/Integrum-Global/kailash-kaizen#readme)
...
`pip install kailash-nexus` | [Repository](https://github.com/Integrum-Global/kailash-nexus) | [Documentation](https://github.com/Integrum-Global/kailash-nexus#readme)
...
`pip install kailash-dataflow` | [Repository](https://github.com/Integrum-Global/kailash-dataflow) | [Documentation](https://github.com/Integrum-Global/kailash-dataflow#readme)
...
| --------------------------------------------------------------- | ------- | -------------------------------------------------------------------------------------------------- |
| [Kaizen](https://github.com/Integrum-Global/kailash-kaizen)     | v1.2.1  | Signature-based AI agents, multi-agent coordination, CARE/EATP trust, FallbackRouter, MCP sessions |
| [Nexus](https://github.com/Integrum-Global/kailash-nexus)       | v1.4.1  | Multi-channel deploy (API+CLI+MCP), handler pattern, NexusAuthPlugin, presets, middleware API      |
| [DataFlow](https://github.com/Integrum-Global/kailash-dataflow) | v0.12.1 | 11 nodes per model, PostgreSQL/MySQL/SQLite parity, auto-wired multi-tenancy, async transactions   |
...
| [Kaizen Guide](https://github.com/Integrum-Global/kailash-kaizen#readme)     | AI agents, signatures, multi-modal, CARE/EATP trust |
| [Nexus Guide](https://github.com/Integrum-Global/kailash-nexus#readme)       | Multi-channel platform, auth, middleware, handlers  |
| [DataFlow Guide](https://github.com/Integrum-Global/kailash-dataflow#readme) | Database operations, models, queries, multi-tenancy |
| [Enterprise Patterns](sdk-users/5-enterprise/)                               | Production deployment patterns                      |
| [API Reference](https://Integrum-Global.github.io/kailash_sdk)               | Sphinx-generated API documentation                  |
...
<p align="center">
  ...
  <a href="https://github.com/Integrum-Global/kailash_sdk">GitHub</a>
</p>
